...
const SkeletonLoader = () => {
  const SkeletonBar = ({ width, delay, opacity = [0.3, 0.6, 0.3] }: SkeletonBarProps) => (
    <motion.div
  ...
  const UserSkeletonBubble = ({ delay, children }: SkeletonBubbleProps) => (
  ...
  const AISkeletonBubble = ({ delay, children }: SkeletonBubbleProps) => (
