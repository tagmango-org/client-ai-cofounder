...
export default function KnowledgeBase() {
  ...
  const fetchArticles = async () => {
    setIsLoading(true);
    const fetchedArticles = await KnowledgeArticle.list('-created_date');
  ...
  const handleSubmit = async (e) => {
    ...
    if (currentArticle) {
      await KnowledgeArticle.update(currentArticle.id, articleData);
    } else {
      await KnowledgeArticle.create(articleData);
    }
    fetchArticles();
